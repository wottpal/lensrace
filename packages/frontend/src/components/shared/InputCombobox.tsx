  ...
  return (
    <Combobox as="div" value={selectedPerson} onChange={setSelectedPerson}>
      <div tw="relative mt-1">
        <Combobox.Input
          tw="w-full rounded-md border border-gray-300 bg-white py-2 pl-3 pr-10 shadow-sm focus:(border-indigo-500 outline-none ring-1 ring-indigo-500) sm:text-sm"
                ...
                {({ active, selected }) => (
                  <>
                    <div tw="flex items-center">
                      <img src={person.imageUrl} alt="" tw="h-6 w-6 flex-shrink-0 rounded-full" />
